...
class _FormPageState extends State<FormPage> {
  ...
  void validation(
    ...
    if (formKey.currentState!.validate()) {
      ...
      //var endDate =new DateTime(startDay.year, startDay.month + 1, startDay.day);
      String formatedEndDate = '${endDay}-${endMonth}-${endYear}';
