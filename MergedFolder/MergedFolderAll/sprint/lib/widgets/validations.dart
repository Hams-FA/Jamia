class Validations {
  String? validate(int decide, String value) {
    ...
    switch (decide) {
      ...
      case 12:
        //card owner name
        return validateCardOwnerName(value);
      default:
        return null;
    }
  }
  ...
  String? validateCardNumber(String value) {
    ...
    // if the card number is obligatory uncomment the comment below
    if (value.isEmpty || value.trim().isEmpty) {
      return null;
      // return ("الرجاء ادخال رقم البطاقة");
    }
    if (!regex.hasMatch(value)) {
      return ("رقم البطاقة المدخل غير صحيح");
    }
    if (value.length < 10) {
      return ("رقم البطاقة المدخل غير صحيح");
    }
  ...
  String? validateCardOwnerName(String value) {
    ...
    if (!regex.hasMatch(value)) {
      return ("الاسم المدخل لا يطابق المعايير");
    }
    if (value.length > 30) {
      return ("الأسم المدخل طويل");
    }
    return null;
  }
